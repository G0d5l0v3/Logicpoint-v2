...
const ServicesWeOffer = () => {
  return (
    <div className="">
      <div className="flex flex-col min-h-screen py-[7rem] sm:justify-center sm:items-center min-h-screen 2xl:min-h-[80svh] max-w-[1440px] mx-auto px-[1rem] sm:px-[5rem] py-[2rem]">
        <div>
