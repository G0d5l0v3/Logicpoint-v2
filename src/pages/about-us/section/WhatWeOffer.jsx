...
const WhatWeOffer = () => {
  return (
    <div className="relative  py-64">
      <div className="absolute top-0 left-0 right-0 -m-8 bg-[#ece7eb] w-[90%] md:w-[90%] lg:w-[70%] xl:w-[60%]  py-8 sm:py-12 md:py-16 lg:py-20 shadow-lg max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="">
