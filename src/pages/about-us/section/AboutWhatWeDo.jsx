...
const AboutWhatWeDo = () => {
  return (
    <div className="bg-[#181830] px-[1rem] py-[5rem] text-white">
      <div className="flex items-center justify-between lg:max-w-[1240px] lg:mx-[auto]">
        <div>
          <h1 className="font-[exo] font-semibold text-3xl sm:text-4xl lg:text-5xl ">
